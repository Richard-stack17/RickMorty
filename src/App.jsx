...
function App() {
  ...
  return (
    <div className="App">
      <div className='in'>
        <h1 className='in__title'>Rick and Morty</h1>
        <form className='in__form'onSubmit={handleSubmit}>
            <input id='inputSearch' type='text' className='in__input'/>
            <button className='button in__button'>Search</button>
        </form>
      </div>
     {
      hasError?
